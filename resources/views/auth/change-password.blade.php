...
<head>
    ...
    <title>Update Password | Aviat</title>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="{{ asset('assets/img/logo/logo.png') }}" alt="Logo Aviat" width="24">
                                </span>
                        ...
                        <p class="mb-4">Silakan Update Password Anda </p>
                        <form class="mb-3" action="{{ route('changePassword') }}" method="POST">
                            @csrf
                            @if (session('status'))
                            ...
                            <div class="mb-3 form-password-toggle">
                                <div class="d-flex justify-content-between">
                                    <label class="form-label" for="password">Password Terbaru</label>
                                </div>
                                <div class="input-group input-group-merge">
