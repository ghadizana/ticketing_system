...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboards -->
        <li class="menu-item {{ Request::is('masterUser*', 'grup-user*', 'menu*', 'permission*') ? 'open active' : '' }}">  
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Dashboards">Master</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('masterUser*') ? 'active' : '' }}">
                ...
                <li class="menu-item {{ Request::is('grup-user*') ? 'active' : '' }}">
                    <a href="{{ route('grup-user.index') }}" class="menu-link">
        ...
        <li class="menu-item {{ Request::is('proyek*', 'mandays*', 'tiket*') ? 'open active' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-error-alt"></i>
                <div data-i18n="Dashboards">Issue</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ Request::is('proyek*') ? 'active' : '' }}">
                    <a href="{{ route('proyek.index') }}" class="menu-link">
                        <div data-i18n="CRM">Proyek</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('mandays*') ? 'active' : '' }}">
                    <a href="{{ route('mandays.index') }}" class="menu-link">
                        <div data-i18n="CRM">Mandays</div>
                    </a>
                </li>
                <li class="menu-item {{ Request::is('tiket*') ? 'active' : '' }}">
                    <a href="{{ route('tiket.index') }}" class="menu-link">
                        <div data-i18n="CRM">Tiket</div>
                    </a>
                </li>
            </ul>
        </li>
